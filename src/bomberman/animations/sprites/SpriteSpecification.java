...
public enum SpriteSpecification {
	...
	PLAYERDIE(30,0.1, getDieSpecs(),GlobalConstants.PLAYER_WIDTH+2, GlobalConstants.PLAYER_HEIGHT+2, 2, false),
	...
	SpriteSpecification(int actualSize, double playSpeed, List<Rectangle> specifications,
	...
	private void spriteInit(int actualSize, double playSpeed, double width, double height, int scale, boolean leftToRight, int numberOfFrames ) {
